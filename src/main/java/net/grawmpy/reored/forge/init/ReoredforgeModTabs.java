...
public class ReoredforgeModTabs {
	...
	public static final RegistryObject<CreativeModeTab> REORED_TOOLS = REGISTRY.register("reored_tools",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.reoredforge.reored_tools")).icon(() -> new ItemStack(ReoredforgeModItems.SIVER_PICKAXE.get())).displayItems((parameters, tabData) -> {
